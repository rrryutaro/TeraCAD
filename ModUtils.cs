...
namespace TeraCAD
{
    public static class ModUtils
    {
        ...
        public const int TextureMaxTile = 128;
        ...
        public static Texture2D Resize(this Texture2D[,] textures, int size)
        {
            ...
            for (int x = 0; x < maxX; x++)
            {
                for (int y = 0; y < maxY; y++)
                {
                    ...
                    //if (size < widths.Sum() + width)
                    //    width -= widths.Sum() + width - size;
                    //if (size < heights.Sum() + height)
                    //    height -= heights.Sum() + height - size;
